...
from utils.basic_bs4_extract_text_utils import bs4_is_html

from utils.get_search_results import get_search_results
from utils.recursive_bs4_extract_text_utils import bs4_recursive_extract_text, ExtractedText
...
if __name__ == "__main__":
    ...
    for batch in raw_text:
        if not bs4_is_html(batch.text):
            LOGGER.info("\n\n==========\n\n")
            LOGGER.info(len(batch.text))
            LOGGER.info(batch.text)
            LOGGER.info("\n\n==========\n\n")
